...
const Footer = () => {
  return (
    <>
      <footer className="mt-10 px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-white pt-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                    <div className="sm:col-span-2 lg:col-span-1">
                        <a href="/">
                        <img src={assets.logo} alt="Logo" className="w-32 h-10"/>
                            
                        </a>
                        <p>flipearn is a social media marketplace . We are the leading social media marketplace that connects brands with their customers With our user-friendly interface</p>
                    </div>
                ...
                <p className="py-4 text-center border-t mt-6 border-slate-200">
                    Copyright 2025 © Mohit soni All Right Reserved.
                </p>
            </footer>
    </>
  )
